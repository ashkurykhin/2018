...
```{r}
price_stormy_ols <- lm(price ~ weather, data=fishmarket)

quan_stormy_ols <- lm(quan/1000 ~ weather, data = fishmarket)
...
quan_price_first <- lm(quan/1000 ~ price, data=fishmarket) 
...
```{r,message=FALSE}
setwd("D:/ASUS WebStorage/R Data Folder/ECN431/lab2")
